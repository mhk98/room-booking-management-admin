...
import { useDeleteBookingMutation, useGetAllBookingQuery } from "../../features/bookings/bookings";
...
const BookingDetails = () => {
  ...
  const handleDelete = async (id) => {
    ...
    console.log('bookingDetails', res);
    if (res) {
        ...
        <tbody>
          {isLoading ? (
            ...
            bookings.map((booking) => (
              <tr className="bg-base-200" key={booking._id}>
